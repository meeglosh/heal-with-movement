...
<section class="section alt">
  <div class="wrap grid grid-2" style="align-items:center;">
    ...
    <div class="settle">
      <img src="/assets/img/abm-brain-sketch.png" alt="Hand-drawn side-view brain sketch in plum ink with curved folds and radiating dots" width="1254" height="1254" loading="lazy" decoding="async" style="display:block; width:100%; height:auto; border-radius:2px;">
    </div>
  </div>
</section>
