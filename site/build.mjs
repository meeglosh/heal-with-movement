...
<section class="section alt">
  <div class="wrap grid grid-2" style="align-items:center;">
    ...
    <div class="settle">
      <img src="/assets/img/abm-neural-pathways-line-art.png" alt="Minimalist plum line drawing of an abstract brain with curved neural pathways and nodes" width="1254" height="1254" loading="lazy" decoding="async" style="display:block; width:100%; height:auto; border-radius:2px;">
    </div>
  </div>
</section>
